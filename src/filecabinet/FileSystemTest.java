...
public class FileSystemTest
{
  ...
  public static final String DATA_DIR = FileSystem.instance().join("etc", "test_data");

  public static String dataDirPath(String... args)
  {
    return FileSystem.instance().join(DATA_DIR, FileSystem.instance().join(args));
  }
  ...
  {
    fs = new FileSystem();
    jarPath = "jar:file:" + dataDirPath("calc.jar!");
  }
