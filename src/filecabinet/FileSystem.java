...
public class FileSystem
{
  ...
  private static class FilePath implements Path
  {
    ...
    public void mkdirs()
    {
      if(!file().exists() && !file().mkdirs())
        throw new RuntimeException("Can't establish directory: " + path);
    }
  ...
  private static class ZipPath implements Path
  {
    ...
    public void mkdirs()
    {
      throw new RuntimeException("JarPath.mkdirs() is not supported");
    }
    ...
    public OutputStream outputStream()
    {
      throw new RuntimeException("JarPath.outputStream() is not supported");
    }
    ...
    public void delete()
    {
      throw new RuntimeException("JarPath.delete() is not supported");
    }
    ...
    public File file()
    {
      throw new RuntimeException("JarPath.file() is not supported");
    }
  }
}
